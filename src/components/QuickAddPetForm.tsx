...
export function QuickAddPetForm({ onSuccess, onError }: QuickAddPetFormProps) {
  ...
  const validateStep = async (step: number) => {
    ...
    switch (step) {
      ...
      case 1:
        fieldsToValidate = [
          "location.city" as keyof PetFormData,
          "location.state" as keyof PetFormData,
          "location.country" as keyof PetFormData,
        ];
        break;
      case 2:
        fieldsToValidate = [
          "healthInfo.vaccinated" as keyof PetFormData,
          "healthInfo.neutered" as keyof PetFormData,
          "healthInfo.microchipped" as keyof PetFormData,
        ];
        break;
      case 3:
